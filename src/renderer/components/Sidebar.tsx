...
import CommandMemoryPanel from './CommandMemoryPanel'
import type { MemoryCommand } from '../types/commandMemory'
...
interface Props {
  ...
  onAddMemoryCommand: (cmd: Omit<MemoryCommand, 'id' | 'createdAt' | 'updatedAt' | 'useCount'>) => void
  onDeleteMemoryCommand: (id: string) => void
  onTogglePinMemoryCommand: (id: string) => void
...
export default function Sidebar({
  ...
  memoryCommands,
  onAddMemoryCommand,
  onDeleteMemoryCommand,
  onTogglePinMemoryCommand,
  onRunCommand,
  onInsertCommand,
  activeWorkspaceId,
  projectRoot,
}: Props) {
  const [activePanel, setActivePanel] = useState<Panel>('commands')
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        {activePanel === 'commands' && (
          <CommandMemoryPanel
            ...
            onAdd={onAddMemoryCommand}
            onDelete={onDeleteMemoryCommand}
            onTogglePin={onTogglePinMemoryCommand}
            onRun={onRunCommand}
